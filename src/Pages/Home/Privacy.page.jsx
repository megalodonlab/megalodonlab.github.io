            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h1 className="text-center my-5"> Privacy </h1>
						...
						<p class="text-left ">We respect our applicants' privacy. If you don’t want us to keep your information anymore, you could email us at <a href="mailto:mystery@megalodon2202.com" title="mail" target="new">mystery@megalodon2202.com</a>, we will delete your stored information. Exceptions may apply if you are a current member of our team, as we might have to maintain the records for the purposes of continuation of the duties in the most effective way.</p>
						...
						<p class="text-left ">Please email us at <a href="mailto:mystery@megalodon2202.com" title="mail" target="new">mystery@megalodon2202.com</a>, for any concerns about privacy, we will try our best to reach back to you as soon as possible.</p>
                    </div>
                </div>
            </div>
        </section>
