export function About() {
    return (
        ...
        <div className="about container">
            ...
            <p>Megalodon Lab is a virtual open-source development platform. We do take programmers from all over the world. However, currently, all of our team members are working remotely from Canada.</p>
            <br />
