       ...
       <HeaderImage />
            ...
            <div className="container">
                ...
                <div className="row"> 
                    ...
                    <div className="col-lg-6 col-md-6">
						...
						<br/>
                        <a href="aboutus" className="btn-blue-gradient">KNOW MORE</a>
                        <a href="team" className="btn-transparent">THE TEAM</a>
                    </div>
                </div>
        ...
        <section className="templatemo-container light-gray-bg section-shadow-bottom">
            <div className="container">
				...
				<p align="center"><a href="#" className="btn-transparent">LEARN MORE</a></p>
            </div>
        </section>
