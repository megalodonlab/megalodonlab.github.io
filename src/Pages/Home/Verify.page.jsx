                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <p className="text-left gray-text">If you are a potential employer for one of our team members and want to verify the person's validity at the Project Megalodon 2202, insert the authentication ID mentioned in the appointment letter. This portal helps you to know the person's validity, last assigned position and duration of work at our lab.</p>
                            <p className="text-left gray-text">If you are a present member or alumni and need a reference letter from us, then email us at <a href="mailto:mystery@megalodon2202.com" target="new">mystery@megalodon2202.com</a> with a subject "Reference Letter" and mention your Authentication ID in the body.</p>
                            <p><br/></p>
                            ...
                            <form id="form" action="#" method="post" className="tm-contact-form">
                                <div className="tm-contact-form">
                                    ...
                                    <div className="form-group" id="boton">
