                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <p className="text-left gray-text">If you are a present member or alumni and need a reference letter from us, then email us at <a href={LINK_ROUTES.mail_A_TAG} target="new"> {LINK_ROUTES.mail_OFFICE} </a> with a subject "Reference Letter" and mention your Authentication ID in the body.</p>
                            <p><br/></p>
