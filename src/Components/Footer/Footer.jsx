            ...
            <div className="container">
                ...
                <div className="col-lg-2 col-md-2 col-sm-6 col-6 footer-block">
                    <ul>
                        ...
                        <li><Link to={LINK_ROUTES.RESEARCH} target="_self">Research</Link></li>
                ...
                <div className="col-lg-2 col-md-2 col-sm-6 col-6 footer-block">
                    <ul>
                        ...
                        <li><a  href={LINK_ROUTES.a_TAG_CAREER} target="_blank">Career</a></li>   
                    </ul>
                </div>
                <div className="col-lg-2 col-md-2 col-sm-6 col-6 footer-block">
                    <ul>
                        <li><Link to={LINK_ROUTES.TEAM_RESOURCES} target="_self">Team Resources</Link></li>
                        <li><Link to={LINK_ROUTES.VERIFY} target="_self">Verify Member</Link></li>
				...
				<div className="col-lg-2 col-md-2 col-sm-6 col-6 footer-block footer-icon"> 
					<p>Get in touch</p>
                        <a href={LINK_ROUTES.mail_A_TAG} target="_blank">
                            <EnvelopeSimple />
                        </a>&nbsp;&nbsp;
					<a href={LINK_ROUTES.a_TAG_LINKEDIN} target="_blank">
                        <LinkedinLogo />
                    </a> 
					&nbsp;&nbsp;<a href={LINK_ROUTES.a_TAG_GIHUB} target="_blank">
                        <GithubLogo />
                    </a>
